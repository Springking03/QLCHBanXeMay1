...
namespace QLCHBanXeMay
{
    public partial class frmLoaixe : Form
    {
        ...
        private void Load_DataGridView()
        {
            ...
            tblLoaixe = Class.Functions.getdatatotable(sql);
            dgvLoaixe.DataSource = tblLoaixe;
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            sql = "SELECT MaLoai FROM tblTheLoai WHERE MaLoai='" +
            txtMaloai.Text.Trim() + "'";
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            {
                sql = "DELETE tblLoaixe WHERE MaLoai='" + txtMaloai.Text + "'";
